...
Certainly! I'll focus on the last section about how to use the `NMPCSolver` class based on the information provided. Here's the revised markdown content for that specific section:
